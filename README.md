...
### Pengcheng Qi
I looked for and arranged the assets for the scene, like the ice-cream shop, the npcs, the environment, and the props inside the ice-cream shop. I also made a rough first version of the NPCs' script. I fixed some minor problems like spelling mistakes in the dialogs and changed some minor things in scripts such as the GameController so that the player's hand can hold the correct item.
### Allen Gu
